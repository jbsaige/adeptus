...
public class WeaponTwo : MonoBehaviour 
{
    ...
    public enum MeleeType { GiantStomp, KrakenGrapple, Thunderclap, TailSlap, BehemothPunch, Blink, Whirlwind, BirdSpeedBurst, JuggerPunch,  WraithPunch, PoisonArrow, Stinger, AdeptShield, DragonBiteOne, DragoneBiteTwo, DragonBiteThree, DragonBiteFour   };
